<template>
  <div class="m-b">
    ...
    <img src="../../../../resources/images/color-wheel.png" class="colorWheel"
      @click="() => { onColorPicker = !onColorPicker }" width="27">
    <div class="colorDiv">
      <!-- <img src="../../../../resources/images/color-wheel.png" @click="()=>{onColorPicker = !onColorPicker}"> -->
      <input type="text" :placeholder="menuEntity.placeholder" :value="color" @change="menuEntity.onValueChange"
