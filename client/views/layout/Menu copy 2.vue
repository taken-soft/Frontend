<template>
  ...
  <div>
              ...
              >
                ...
                <div v-if="item.showContent" class="accordion-content">
                  ...
                  <div v-show="item.content1">
                    <div class="m-b">
                      ...
                      <div v-if="selectedOption === 'option1'" class="morepage">
                        <div class="m-b">                          
                          <label class="flex m-r" for="">장비명<img
                        ...
                        <div class="m-b">
                          ...
                          <div class="flex">
                            <input type="text" placeholder="30이상" /><input
                              type="text"
                              placeholder="10미만"
                            />
                          </div>
                  ...
                  <div v-show="item.content5">
                    <div class="addwidget">
                      <div class="widget">chart1</div>
                      <div class="widget">chart2</div>
                      <div class="widget">chart3</div>
                      <div class="widget">chart4</div>
                    </div>
                  </div>
    ...
    <router-link to="/Dashboard2.page"
      ><p class="m-b">대시보드 2</p></router-link
    >
